...
import { SparklesIcon, ArrowRightIcon, ArrowLeftIcon } from "@heroicons/react/24/outline";
...
export default function UploadJob() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    // Save job description to localStorage or state management
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-blue-600">Upload Job</span>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Upload Job Description</h2>
          <p className="text-lg text-gray-600">
            Start by adding the job description you want to match candidates against
          </p>
        </div>
